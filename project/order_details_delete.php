...
$select = "SELECT order_id AS orderid FROM order_details WHERE detail_id =:detail_id";
...
try {
    ...
    $count = $stmt->rowCount();
    if ($count == 1) {
        $query = "DELETE FROM order_details WHERE detail_id =:detail_id;DELETE FROM order_summary WHERE order_id =:order_id";
